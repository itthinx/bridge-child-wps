...
form.qode_search_form_2 div.product-search {
	display: inline-block;
	width: 90%;
	font-size: 14px;
	vertical-align: top;
}
form.qode_search_form_2 div.product-search .title {
	height: initial;
}
form.qode_search_form_2 div.product-search .product-search-field-clear {
	font-size: 28px;
	color: #f33;
}
</style>
